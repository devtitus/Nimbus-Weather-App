                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    <span class="m-icon">location_on</span>
                        ...
                        <div>
                            ...
                            <p class="label-2 item-subtitle">${state || ""
                        }, ${country}</p>
                        </div>
...
export const updateWeather = function (lat, lon) {
    ...
    fetchdata(url.currentWeather(lat, lon), function (currentWeather) {
        const {
            weather,
            dt: dateUnix,
            sys: { sunrise: sunriseUnixUTC, sunset: sunsetUnix },
                    ...
                    timezone
                            ...
                            <div class="card card-sm highlight-card">
                                ...
                                <div class="wrapper">
                                    ...
                                    <p class="title-1">${visibility / 1000
                }<sup>km</sup></p>
                                </div>
                            </div>
                            <!--#6-->
            ...
            fetchdata(url.forecast(lat, lon), function (forecast) {
                ...
                for (const [index, data] of forecastList.entries()) {
                    ...
                    <div class="card card-sm slider-card">
                                    <p class="body-3">${module.getHours(dateUnix, timezone)}</p>
                    ...
                    <div class="card card-sm slider-card">
                                    ...
                                    <img src="./assets/images/weather_icons/direction.png" width="48" height="48"
                                        loading="lazy" class="weather-icon" style="transform: rotate(${windDirection - 180}deg) alt="direction">
                ...
                for (let i = 7, len = forecastList.length; i < len; i += 8) {
                    ...
                    <div class="icon-wrapper">
                                    <img src="./assets/images/weather_icons/${icon}.png" class="weather-icon" width="36"
